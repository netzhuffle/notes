...
class NotePatchTest extends TestCase
{
    ...
    public function test_unauthorised_returns_401(): void
    {
        ...
        $response = $this->patchJson("/api/v1/notes/$note->id", [
            'title' => $noteNewTitle,
            'content' => 'New content',
        ]);
    ...
    public function test_full_note_returns_200_and_note(): void
    {
        ...
        $response = $this->actingAs($user)->patchJson("/api/v1/notes/$noteId", [
            'title' => $noteNewTitle,
    ...
    public function test_title_only_keeps_content_and_returns_200_and_note(): void
    {
        $noteTitle = 'Test note';
        $noteContent = 'Test note content';
        $noteNewTitle = 'New title';
    ...
    public function test_content_only_keeps_title_and_returns_200_and_message(): void
    {
        $noteTitle = 'Test note';
        $noteContent = 'Test note content';
        $noteNewContent = 'New content';
